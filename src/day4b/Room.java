...
public class Room {
	...
	private static String getNameParts(String room) {
		return room.substring(0, room.lastIndexOf('-'));
	}
	...
	public static int getSector(String room) {

		String nameAndSector = room.substring(0, room.lastIndexOf('['));
		String sector = nameAndSector.substring(nameAndSector.lastIndexOf('-') + 1);

		return Integer.parseInt(sector);
	}

	public static String decriptRoom(String room) {
