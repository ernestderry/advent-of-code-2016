...
public class TestBuildingState {
	...
	@Test
	public void cannotMoveGeneratorDownToFloorThatContainsAMicrochipWithoutItsGenerator() {
		BuildingState bs = new BuildingState(2);
		ChipPair cp = new ChipPair(4, 1);
		bs.addChipPair(cp);
	...
	@Test
	public void cannotMoveGeneratorUpToFloorThatContainsAMicrochipWithoutItsGenerator() {
		BuildingState bs = new BuildingState(3);
		ChipPair cp = new ChipPair(1, 4);
		bs.addChipPair(cp);
